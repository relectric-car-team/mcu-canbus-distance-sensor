...
# 13 "distance-sensor.c" 2

# 1 "./mcc_generated_files/device_config.h" 1
# 14 "distance-sensor.c" 2
...
void handleEcho() {
    if (PORTCbits.RC5 == 1) {
        ...
        TMR2_StopTimer();
        timerTicks = TMR2_ReadTimer();
        distanceError = TMR2_HasOverflowOccured();
        TMR2_WriteTimer(0);
